            ...
            <div class="login-header login-caret">
                <div class="login-content" style="width:80%;">
                    <a href="<?php echo base_url(); ?>" class="logo">
                        <img src="assets/images/corazon-logo.png" height="70" alt="" />
                    </a>
                    <p class="description">
                    <h2 style="color:#cacaca; font-weight:80;">
            ...
            <div class="login-form">
                <div class="login-content">
                    <div class="form-login-error">
                        ...
                        <p>Por favor ingrese un usuario y contraseña valido!</p>
                    </div>
                    <form method="post" role="form" id="form_login">
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary btn-block btn-login">
                                ...
                                <center> <?php echo get_phrase('login'); ?></center>
                            </button>
                        </div>
					...
					<a href="<?php echo base_url();?>index.php?login/forgot_password">
						<b><?php echo get_phrase('forgot_password');?>?</b>
                    </a>
