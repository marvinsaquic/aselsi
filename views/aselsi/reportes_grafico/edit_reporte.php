<?php
$single_donante_info = $this->db->get_where('cdp_donante', array('do_id' => $param2))->result_array();
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <!--donacion-->
                    <div class="form-group">
                        <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('donacion'); ?></label>
                        <div class="col-sm-5">
                            <input type="text" name="donacion" class="form-control" id="field-1" value="<?php echo $row['don_donacion']; ?>" required>
                        </div>
                    </div>
