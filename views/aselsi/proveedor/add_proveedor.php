        ...
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-heading">
                <div class="panel-title">
                    <h3><?php echo get_phrase('add_proveedor'); ?></h3>
                </div>
            </div>

            <div class="panel-body">

                <form role="form" class="form-horizontal form-groups-bordered validate" action="<?php echo base_url(); ?>index.php?aselsi/proveedor/create" method="post" enctype="multipart/form-data">
                    <!-- nombre -->
