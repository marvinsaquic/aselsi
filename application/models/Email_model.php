...
class Email_model extends CI_Model {
    ...
    function account_opening_email($account_type = '', $email = '', $password = '') {
        $system_name = $this->db->get_where('crg_settings', array('type' => 'system_name'))->row()->description;
    ...
    function do_email($msg = NULL, $sub = NULL, $to = NULL, $from = NULL) {
        ...
        if ($from == NULL)
            $from = $this->db->get_where('crg_settings', array('se_type' => 'system_email'))->row()->se_descripcion;
